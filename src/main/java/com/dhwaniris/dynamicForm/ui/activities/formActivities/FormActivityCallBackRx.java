...
public class FormActivityCallBackRx extends BaseFormActivity implements View.OnClickListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bindView();
        superViewBind();
        ctx = FormActivityCallBackRx.this;
...
//        }
    ...
    class SaveData extends AsyncTask<Void, Void, Boolean> {
        ...
        protected void onPostExecute(Boolean aBoolean) {
            if (singletonForm.getWorkOnSubmit() != null) {
    ...
    void workCompletion(boolean isFinish, int status) {
        hideLoading();
        if (isFinish) {
            if (status == SUBMITTED) {
